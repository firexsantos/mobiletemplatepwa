...
$(window).on('load', function () {
    ...
    switch (body.attr('data-page')) {
        ...
        case "landing":
            ...
            var introswiperbottom = new Swiper(".introswiperbottom", {
            ...
            introswiperbottom.on('reachEnd', function () {
                introswiperbottom.autoplay = false;
                setTimeout(function () {
        ...
        case 'schedule':
            /* swiper carousel cardwiper */
            var swiper1 = new Swiper(".scrollx", {
                slidesPerView: "auto",
                spaceBetween: 0,
                pagination: false
            });
        ...
        case 'blog':
            ...
            var swiper12 = new Swiper(".blogswiper", {
                slidesPerView: "auto",
                spaceBetween: 0,
                pagination: false
            });
