...
$(window).on('load', function () {
    ...
    switch (body.attr('data-page')) {
        ...
        case "landing":
            ...
            $('.introslides').css('height', ($(window).height() - 80) + 'px');
        ...
        case "thankyou":
            $('.h-flex').css('height', ($(window).height() - 80) + 'px');
            setTimeout(function () {
                window.location.replace("signin.html");
            }, 4000)
            break;
        ...
        case 'stats':
            ...
            gradient3.addColorStop(0, 'rgba(58, 199, 155, 0.6)');
            gradient3.addColorStop(1, 'rgba(58, 199, 155, 0)');
            ...
            var gradient4 = areachart3.createLinearGradient(0, 0, 0, 1);
            gradient4.addColorStop(0, 'rgba(58, 199, 155, 0.6)');
            gradient4.addColorStop(0.5, 'rgba(58, 199, 155, 0.0)');
